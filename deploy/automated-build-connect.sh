...
export ARCHIVEMATICA_SERVICE_SEEDER_STORAGE_ID="4d3d72a0-7023-11ea-9e4b-9d55b3d96e2e"
...
if [[ ! -z $ARCHIVEMATICA_SERVICE_SEEDER_STORAGE_ID ]] ; then
  echo "" >> .env
...
if [[ ! -z $ARCHIVEMATICA_SERVICE_SEEDER_API_AUTHORIZATION_KEY ]] ; then
  echo "" >> .env
