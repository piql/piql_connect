        ...
        <div class="col-sm-12">
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div>
                        <div class="row pt-3" style="justify-content: space-evenly;margin-top: 30px;">
                            <div class="card dashboard-card" class="col-sm-3" style="height:100px;width: 150px;">
                                <h2 style="color: white;text-align: center;padding-top: 25px;font-size: 300%">
                            ...
                            <div class="card dashboard-card" class="col-sm-3" style="height:100px;width: 150px;">
                                ...
                                <em style="color: white;text-align: center;position: absolute;left: 0;right: 0;bottom: 0;">AIPs retrieved</em>
                            </div>
                            <div class="card dashboard-card" class="col-sm-3" style="height:100px;width: 150px;">
                                <h2 style="color: white;text-align: center;padding-top: 25px;font-size: 300%">
                                    <strong>{{ $infoArray['DataRetrieved'] }}</strong>
                                </h2>
                                <em style="color: white;text-align: center;position: absolute;left: 0;right: 0;bottom: 0;">Retrieved</em>
                            </div>
                        </div>
                        <div class="row pt-3" style="justify-content: space-evenly;margin-top: 20px">
                            <div class="card dashboard-card" class="col-sm-3" style="height:100px;width: 150px;">
                                <h2 style="color: white;text-align: center;padding-top: 25px;font-size: 300%">
