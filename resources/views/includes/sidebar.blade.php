<div class="wrapper sideMenu">
    ...
    @if  (\Request::is('ingest/*'))
        <a href="{{ route('holdings') }}"><li class="list-group-item {{ \Request::is('ingest/holdings') ? 'active sidebar-active' : '' }} "><i class="fas fa-suitcase"></i><i class="leftMenuItem"> Holdings</i></li></a>
