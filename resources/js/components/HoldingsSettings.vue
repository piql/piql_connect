        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 col-lg-6 col-xs-6 col-lg-6">
                    <h4>{{$t('Current archives')}}</h4>
                    <ul id="holdingsList" class="list-group mt-4">
                        <li class="list-group-item list-group-item-light" v-for="holding in holdings">{{ holding.title }} <button class="btn btn-sm btn-right">{{$t('Assign holdings')}}</button></li>
                    </ul>
                </div>
                <div class="col-sm-1"></div>
                <div class="col-sm-5">
                    <h4>Create new archive</h4>
                    <form class="form mb-3" v-on:submit.prevent>
                        ...
                        <div class="form-group form-submit">
                            <button class="btn btn-primary btn-right" @click="createHolding">Create archive</button>
                        </div>
                    </form>
                </div>
            </div>
